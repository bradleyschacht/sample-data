...
[array]$file_list =
    @(
        ...
        @{file_name = "AdventureWorksSamples.zip"       ; data_subdirectory = "Raw\";                                   url = "https://github.com/microsoft/sql-server-samples/archive/refs/tags/adventureworks.zip"},
        ...
        @{file_name = "AdventureWorksDW2012Images.zip"  ; data_subdirectory = "Raw\";                                   url = "https://github.com/Microsoft/sql-server-samples/releases/download/adventureworks2012/adventure-works-2012-dw-images.zip"},
        ...
        @{file_name = "AdventureWorks2014InMemory.zip"  ; data_subdirectory = "Raw\AdventureWorks 2014 In Memory";      url = "https://github.com/microsoft/sql-server-samples/releases/download/adventureworks/adventure-works-2014-oltp-in-memory-sample.zip"},
        ...
        @{file_name = "AdventureWorks2016.zip"          ; data_subdirectory = "Raw\";                                   url = "https://github.com/microsoft/sql-server-samples/releases/download/adventureworks/sql-server-2016-samples.zip"}
)
