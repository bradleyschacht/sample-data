    ...
    IF @Query = 'TPC-DS Query 34'
        select c_last_name
           ...
           (select ss_ticket_number
            ...
            and store.s_county in ('Carter County','Newport County','Green Lake County','Dade County',
                                   'Brazos County','Wolfe County','Jasper County','Union County')
