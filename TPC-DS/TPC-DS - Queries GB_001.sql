    ...
    /*************************************   TPCDS Query 09   *************************************/
        ...
        select case when (select count(*) 
               ...
               case when (select count(*)
                          from store_sales
                          where ss_quantity between 21 and 40) > 28156
                    then (select avg(ss_ext_list_price)
                          from store_sales
               ...
               case when (select count(*)
                          from store_sales
                          where ss_quantity between 41 and 60) > 38264
                    then (select avg(ss_ext_list_price)
                          from store_sales
               ...
               case when (select count(*)
                          from store_sales
                          where ss_quantity between 61 and 80) > 21900
                    then (select avg(ss_ext_list_price)
                          from store_sales
               ...
               case when (select count(*)
                          from store_sales
                          where ss_quantity between 81 and 100) > 41083
                    then (select avg(ss_ext_list_price)
                          from store_sales
    ...
    /*************************************   TPCDS Query 16   *************************************/
        ...
        where
            d_date between '2001-4-01' and 
                   (dateadd(day, + 60, cast('2001-4-01' as date))) /*  (cast('2001-4-01' as date) + 60 days)  */
