...
-- This is the TPCH 100TB SF queries modified for Fabric DW (interval, extract, date, substring and rowcount modification)
-- All the predicates are the same except for Q11
...
--        and l_shipdate < dateadd(mm, 3, '1995-03-01')
--	group by
--		l_suppkey;
